...
echo "======================================================================="
echo "|                                                                     |"
echo "|      full-stack-nginx-laravel-for-everyone-with-docker-compose      |"
echo "|                      by Erdal ALTIN                                 |"
echo "|                                                                     |"
echo "======================================================================="
sleep 2
...
if [ -x "$(command -v docker)" ] && [ "$(docker compose version)" ]; then
	...
	# installing Laravel and the other services
	docker compose up -d & export pid=$!
	echo "Laravel and the other services installing proceeding..."
	echo ""
	wait $pid
	if [ $? -eq 0 ]
	then
